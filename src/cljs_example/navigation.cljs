(ns cljs-example.navigation
  (:require [accountant.core :as accountant]
            [antizer.reagent :as ant]
            [cljs-example.pages.code :as code]
            [cljs-example.pages.coffee :as coffee]
            [cljs-example.state :refer [state update-state!]]
            [cljs-example.utils :refer [index-by]]
